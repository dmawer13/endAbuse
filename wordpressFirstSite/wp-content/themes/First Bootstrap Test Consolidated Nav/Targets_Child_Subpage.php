<?php /* Template Name: Targets_Child_Subpage */ ?>
...
//Child, AudioVideo
$childAV = "SELECT Format, Title, Link, CONCAT('<a href=\"', Link, '\">', Title, '</a>') As ClickLink FROM MASTER1023 WHERE Format = 'AudioVideo' && Child = 'TRUE' ORDER BY TITLE";
//Child, Websites
$childSites = "SELECT Format, Title, Link, CONCAT('<a href=\"', Link, '\">', Title, '</a>') As ClickLink FROM MASTER1023 WHERE Format = 'Website' && Child = 'TRUE' ORDER BY TITLE";
//Child, Websites
$childArticles = "SELECT Format, Title, Link, CONCAT('<a href=\"', Link, '\">', Title, '</a>') As ClickLink FROM MASTER1023 WHERE Format = 'Article' && Child = 'TRUE' ORDER BY TITLE";
//Child, Websites
$childBlogs = "SELECT Format, Title, Link, CONCAT('<a href=\"', Link, '\">', Title, '</a>') As ClickLink FROM MASTER1023 WHERE Format = 'Blog' && Child = 'TRUE' ORDER BY TITLE";
//Child, Websites
$childFactSheets = "SELECT Format, Title, Link, CONCAT('<a href=\"', Link, '\">', Title, '</a>') As ClickLink FROM MASTER1023 WHERE Format = 'FactSheet' && Child = 'TRUE' ORDER BY TITLE";


// results based on select queries above.
$result1 = mysqli_query($connect, $childAV);
$result2 = mysqli_query($connect, $childSites);
$result3 = mysqli_query($connect, $childArticles);
$result4 = mysqli_query($connect, $childBlogs);
$result5 = mysqli_query($connect, $childFactSheets);
?>
