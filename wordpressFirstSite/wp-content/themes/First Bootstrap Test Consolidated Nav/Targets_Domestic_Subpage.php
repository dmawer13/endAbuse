<?php /* Template Name: Targets_Domestic_Subpage */ ?>
...
//Physical, AudioVideo
$domesticAV = "SELECT Format, Title, Link, CONCAT('<a href=\"', Link, '\">', Title, '</a>') As ClickLink FROM MASTER1023 WHERE Format = 'AudioVideo' && DomesticGroupHome = 'TRUE' ORDER BY TITLE";
//Physical, Websites
$domesticSites = "SELECT Format, Title, Link, CONCAT('<a href=\"', Link, '\">', Title, '</a>') As ClickLink FROM MASTER1023 WHERE Format = 'Website' && DomesticGroupHome = 'TRUE' ORDER BY TITLE";
//Physical, Websites
$domesticArticles = "SELECT Format, Title, Link, CONCAT('<a href=\"', Link, '\">', Title, '</a>') As ClickLink FROM MASTER1023 WHERE Format = 'Article' && DomesticGroupHome = 'TRUE' ORDER BY TITLE";
//Physical, Websites
$domesticBlogs = "SELECT Format, Title, Link, CONCAT('<a href=\"', Link, '\">', Title, '</a>') As ClickLink FROM MASTER1023 WHERE Format = 'Blog' && DomesticGroupHome = 'TRUE' ORDER BY TITLE";
//Physical, Websites
$domesticFactSheets = "SELECT Format, Title, Link, CONCAT('<a href=\"', Link, '\">', Title, '</a>') As ClickLink FROM MASTER1023 WHERE Format = 'FactSheet' && DomesticGroupHome = 'TRUE' ORDER BY TITLE";


// results based on select queries above.
$result1 = mysqli_query($connect, $domesticAV);
$result2 = mysqli_query($connect, $domesticSites);
$result3 = mysqli_query($connect, $domesticArticles);
$result4 = mysqli_query($connect, $domesticBlogs);
$result5 = mysqli_query($connect, $domesticFactSheets);
?>
