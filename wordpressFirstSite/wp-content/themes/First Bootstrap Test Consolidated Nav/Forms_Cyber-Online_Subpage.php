<?php /* Template Name: Forms_Cyber-Online_Subpage */ ?>
...
$cyberAV = "SELECT Format, Title, Link, CONCAT('<a href=\"', Link, '\">', Title, '</a>') As ClickLink FROM MASTER1023 WHERE Format = 'AudioVideo' && CyberOnline = 'TRUE' ORDER BY TITLE";
//Verbal and Psychological, Websites
$cyberSites = "SELECT Format, Title, Link, CONCAT('<a href=\"', Link, '\">', Title, '</a>') As ClickLink FROM MASTER1023 WHERE Format = 'Website' && CyberOnline = 'TRUE' ORDER BY TITLE";
//Verbal and Psychological, Websites
$cyberArticles = "SELECT Format, Title, Link, CONCAT('<a href=\"', Link, '\">', Title, '</a>') As ClickLink FROM MASTER1023 WHERE Format = 'Article' && CyberOnline = 'TRUE' ORDER BY TITLE";
//Verbal and Psychological, Websites
$cyberBlogs = "SELECT Format, Title, Link, CONCAT('<a href=\"', Link, '\">', Title, '</a>') As ClickLink FROM MASTER1023 WHERE Format = 'Blog' && CyberOnline = 'TRUE' ORDER BY TITLE";
//Verbal and Psychological, Websites
$cyberFactSheets = "SELECT Format, Title, Link, CONCAT('<a href=\"', Link, '\">', Title, '</a>') As ClickLink FROM MASTER1023 WHERE Format = 'FactSheet' && CyberOnline = 'TRUE' ORDER BY TITLE";


// results based on select queries above.
$result1 = mysqli_query($connect, $cyberAV);
$result2 = mysqli_query($connect, $cyberSites);
$result3 = mysqli_query($connect, $cyberArticles);
$result4 = mysqli_query($connect, $cyberBlogs);
$result5 = mysqli_query($connect, $cyberFactSheets);
?>
