<?php /* Template Name: Support_Prevention-Advocacy_Subpage */ ?>
...
//Physical, AudioVideo
$preventionAV = "SELECT Format, Title, Link, CONCAT('<a href=\"', Link, '\">', Title, '</a>') As ClickLink FROM MASTER1023 WHERE Format = 'AudioVideo' && PreventionAdvocacy = 'TRUE' ORDER BY TITLE";
//Physical, Websites
$preventionBlogs = "SELECT Format, Title, Link, CONCAT('<a href=\"', Link, '\">', Title, '</a>') As ClickLink FROM MASTER1023 WHERE Format = 'Blog' && PreventionAdvocacy = 'TRUE' ORDER BY TITLE";
//Physical, Websites
$preventionChatRooms = "SELECT Format, Title, Link, CONCAT('<a href=\"', Link, '\">', Title, '</a>') As ClickLink FROM MASTER1023 WHERE Format = 'ChatRoom' && PreventionAdvocacy = 'TRUE' ORDER BY TITLE";
//Physical, Websites
$preventionSites = "SELECT Format, Title, Link, CONCAT('<a href=\"', Link, '\">', Title, '</a>') As ClickLink FROM MASTER1023 WHERE Format = 'Website' && PreventionAdvocacy = 'TRUE' ORDER BY TITLE";
//Physical, Websites
$preventionArticles = "SELECT Format, Title, Link, CONCAT('<a href=\"', Link, '\">', Title, '</a>') As ClickLink FROM MASTER1023 WHERE Format = 'Article' && PreventionAdvocacy = 'TRUE' ORDER BY TITLE";

// results based on select queries above.
$result1 = mysqli_query($connect, $preventionAV);
$result2 = mysqli_query($connect, $preventionBlogs);
$result3 = mysqli_query($connect, $preventionChatRooms);
$result4 = mysqli_query($connect, $preventionSites);
$result5 = mysqli_query($connect, $preventionArticles);
?>
